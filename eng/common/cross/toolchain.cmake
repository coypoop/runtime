...
if(EXISTS ${CROSS_ROOTFS}/bin/freebsd-version)
  ...
  set(FREEBSD 1)
elseif(EXISTS ${CROSS_ROOTFS}/sbin/dkctl)
...
elseif (NETBSD)
  set(CMAKE_SYSTEM_PROCESSOR "x86_64")
  set(triple "x86_64-unknown-netbsd")
elseif (ILLUMOS)
  set(CMAKE_SYSTEM_PROCESSOR "x86_64")
...
elseif(NETBSD)
    ...
    set(CMAKE_ASM_COMPILER_TARGET ${triple})
    set(CMAKE_SYSROOT "${CROSS_ROOTFS}")
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -stdlib=libstdc++ -L=/usr/lib")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -stdlib=libstdc++ -L=/usr/lib")
    set(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} -stdlib=libstdc++ -L=/usr/lib")
elseif(ILLUMOS)
    set(CMAKE_SYSROOT "${CROSS_ROOTFS}")
